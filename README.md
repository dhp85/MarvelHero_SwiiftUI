...
2. Elegir un dispositivo apropiado en el simulador, las pruebas las hice en un iPhone 16 Pro. Si no seleccionas un dispositivo iphone en la barra superior del proyecto, puede que te de errores en el compilador.
